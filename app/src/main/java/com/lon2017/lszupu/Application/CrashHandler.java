...
//            upErrorLog(errorReport);
            ...
            String errorReport = result.toString();
          //  reMove();
            Log.e("CrashHandler", "uncaughtException errorReport=" + errorReport);
            System.exit(0);
        }
    ...
    private void reMove() {
        SharedPreferences settings = mContext.getSharedPreferences("account", Context.MODE_PRIVATE);

        SharedPreferences.Editor editor = settings.edit();

//        editor.remove(Constant.IsLogin);
//
//        editor.remove(Constant.lose);
