...
import Fragment.TabFragmentDynamic;
import Fragment.TabFragmentFriends;
import Fragment.TabFragmentTree;
...
public class MainActivity extends FragmentActivity {
    ...
    CircleImageView header_logo;
    TabsAdapter mTabsAdapter;
    private final Class[] fragments = { TabFragmentFriends.class, TabFragmentTree.class,
            TabFragmentDynamic.class };
    @Override
    ...
    @OnClick({R.id.id_menu,R.id.header_logo})
...
//        UserUtils loginCheck=new UserUtils(this);
//        if (loginCheck.getUserId()==0){
